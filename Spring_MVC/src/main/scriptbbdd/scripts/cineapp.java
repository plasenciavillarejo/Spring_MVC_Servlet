...
public class cineapp {
	...
	CREATE TABLE `Horarios` (
	  ...
	  CONSTRAINT `fk_Horarios_Peliculas1` FOREIGN KEY (`idPelicula`) REFERENCES `Peliculas` (`id`) 
	ON DELETE CASCADE 
	ON UPDATE NO ACTION
	) ENGINE=InnoDB DEFAULT CHARSET=utf8;
	/*!40101 SET character_set_client = @saved_cs_client */;
	...
	CREATE TABLE `UsuarioPerfil` (
	  ...
	  CONSTRAINT `fk_Usuarios_Perfil1` FOREIGN KEY (`username`) REFERENCES `Usuarios` (`username`) 
	ON DELETE CASCADE 
	ON UPDATE NO ACTION
	) ENGINE=InnoDB DEFAULT CHARSET=utf8;
	/*!40101 SET character_set_client = @saved_cs_client */;
